...
func (c *ControllerV1) Retriever(ctx context.Context, req *v1.RetrieverReq) (res *v1.RetrieverRes, err error) {
	...
	g.Log().Infof(ctx, "Retriever request received - Question: %s, TopK: %d, Score: %f, KnowledgeId: %s, EnableRewrite: %v, RewriteAttempts: %d, RetrieveMode: %s",
		req.Question, req.TopK, req.Score, req.KnowledgeId, req.EnableRewrite, req.RewriteAttempts, req.RetrieveMode)
