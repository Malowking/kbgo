...
export default function ConversationSidebar({
  ...
  const confirmDelete = async () => {
    ...
    try {
      await onDeleteConversation(deleteConfirm.convId);
      fetchConversations();
    } catch (error) {
      console.error('Failed to delete conversation:', error);
    } finally {
      setDeleteConfirm({ isOpen: false, convId: null, title: '' });
    }
  };
  ...
  return (
    <>
            ...
            conversations.map((conv) => (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <button
                    onClick={(e) => handleDelete(e, conv.conv_id, conv.title || '未命名对话')}
      ...
      <ConfirmDialog
        ...
        title="删除对话"
        message={`确定要删除对话"${deleteConfirm.title}"吗？\n\n删除后将无法恢复该对话的所有消息记录。`}
        confirmText="删除"
        cancelText="取消"
        type="danger"
